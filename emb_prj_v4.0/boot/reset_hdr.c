...
/********************************************************/
/* 関数   | static void clock_config(UINT clock_kind,   */ 
/*        | u4 auxsrc, u4 src_freq, u4 freq)            */
/* 説明   | 周辺クロックの設定                          */
/* 引数   | UINT clock_kind,                            */ 
/*        | u4 auxsrc, u4 src_freq, u4 freq             */
/* 戻り値 | なし                                        */
...
/********************************************************/
/* 関数   | static void init_clock(void)                */ 
/* 説明   | クロックの初期化                            */
/* 引数   | なし                                        */
/* 戻り値 | なし                                        */
/********************************************************/
...
/********************************************************/
/* 関数   | static void init_section(void)              */ 
/* 説明   | メモリセクションの初期化                    */
/* 引数   | なし                                        */
/* 戻り値 | なし                                        */
/********************************************************/
...
/*** システムタイマの初期化 ***/
/********************************************************/
/* 関数   | static void init_systim(void)               */ 
/* 説明   | システムタイマの初期化                      */
/* 引数   | なし                                        */
/* 戻り値 | なし                                        */
/********************************************************/
