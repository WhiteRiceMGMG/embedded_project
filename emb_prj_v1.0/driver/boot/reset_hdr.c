...
/* PLLの初期化 */
/*********************************************************************************/
/* 関数   | init_pll(UW pll, UINT refdiv, UINT vco_freq, UINT post_div1, UINT post_div2) */
/* 説明   | PLLの初期化                                                            */
/* 引数   | UW pll, UINT refdiv, UINT vco_freq, UINT post_div1, UINT post_div2    */
/* 戻り値 | なし                                                                   */
/* 作成   | 2025 / 10 /03                                                         */
/*********************************************************************************/
...
/* 周辺クロックの設定 */
/*********************************************************************************/
/* 関数   | clock_config(UINT clock_kind, UW auxsrc, UW src_freq, UW freq)        */
/* 説明   |  周辺クロックの設定                                                     */
/* 引数   | UINT clock_kind, UW auxsrc, UW src_freq, UW freq                      */
/* 戻り値 | なし                                                                   */
/* 作成   | 2025 / 10 /03                                                         */
/*********************************************************************************/
